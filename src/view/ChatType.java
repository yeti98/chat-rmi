 ...
 * @author Thanh
 */
public class ChatType extends javax.swing.JFrame {
    ...
    public ChatType(String username, String IP, IRMI rmi) {
    ...
    public static void main(String username, String IP, IRMI rmi) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChatType.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChatType(username, IP, rmi).setVisible(true);
            }
        });
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
//        try {
//            int roomId = Integer.parseInt(jTextField1.getText());
