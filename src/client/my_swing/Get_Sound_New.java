...
public class Get_Sound_New extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        border.setIcon(new javax.swing.ImageIcon(getClass().getResource("/client/icon/border_small.png"))); // NOI18N
        jLayeredPane1.add(border);

        profile.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        profile.setIcon(new javax.swing.ImageIcon(getClass().getResource("/client/icon/profile_small.png"))); // NOI18N
    ...
    private void playMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_playMouseReleased
        if (over) {
            if (!p) {
                play.setValue(0);
                MessageController.getRecoder().playAudio(sound, play);
                p = true;
            } else {
                MessageController.getRecoder().stopPlay();
                p = false;
            }
        }
