...
public class Get_Emoji_New extends javax.swing.JPanel {
    ...
    public void setPhoto(int ID, String emoji) {
        if (MessageController.getFriends().get(ID).getImage() != null) {
            profile.setIcon(MessageController.getFriends().get(ID).getImage());
        }
        lbName.setText(MessageController.getFriends().get(ID).getfName());
        lb.setIcon(new ImageIcon(getClass().getResource("/client/emoji/" + emoji)));
    }
    ...
    private void initComponents() {
        ...
        border.setIcon(new ImageIcon(getClass().getResource("/client/icon/border_small.png"))); // NOI18N
        jLayeredPane1.add(border);

        profile.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        profile.setIcon(new ImageIcon(getClass().getResource("/client/icon/profile_small.png"))); // NOI18N
        jLayeredPane1.add(profile);

        lb.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lb.setIcon(new ImageIcon(getClass().getResource("/client/emoji/emoji_green (1).png"))); // NOI18N
