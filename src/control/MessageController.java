...
import client.function.Recoder;
import client.Main;
import model.Friend;
import client.my_swing.ImageViewer;
...
public class MessageController {
    ...
    public static void connect(int i, String userName, String IP) throws Exception {
...
//        ms.setName(userName + "!" + t);
    ...
    public static void sendMessage(Message message) throws Exception {
        ...
        message.setID(MessageController.getMyID());
        SimpleDateFormat df = new SimpleDateFormat("hh:mm aa");
        String t = df.format(new Date());
        message.setCreateAt(t);
        out.writeObject(message);
...
//                ms.setName(parth);
    ...
    public static Font getFount() {
        return new Font("Khmer SBBIC Serif", 0, 12);
    }

    public static Font getFountBold() {
        return new Font("Khmer SBBIC Serif", 1, 12);
    }
